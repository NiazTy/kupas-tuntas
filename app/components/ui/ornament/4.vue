<template>
    ...
    <!-- Cahaya merah lembut dari kiri -->
    <div class="absolute -left-40 top-1/2 -translate-y-1/2 w-125 h-125 rounded-full bg-[#810000]/30 blur-[120px] pointer-events-none" />
    <!-- Ornamen border luar -->
    ...
    <div class="absolute top-0 left-0 w-full h-32 bg-linear-to-b from-[#0d0a06] to-transparent z-10 pointer-events-none" />
</template>